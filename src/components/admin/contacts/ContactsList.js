...
{/* Editing a contact */}
              ...
              <button onClick={() =>showContact(contact.id)} type="button" className="btn btn-sm pencil-item"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-pencil pencil-item" viewBox="0 0 16 16">
...
{/* Deleting a contact */}
                <button type="button" className="btn btn-danger btn-sm trash-item" id={contact.id} onClick={() =>deleteContact(contact.id)}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-trash trash-item" viewBox="0 0 16 16">
