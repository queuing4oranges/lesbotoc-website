  ...
  return (
    <div>
        ...
        <div className="table-container">
            ...
            <thead>
              <tr>
              <th scope="col" className="col-event">Event</th>
              <th scope="col" className="col-venue">Venue</th>
              <th scope="col" className="col-address">Address</th>
              <th scope="col" className="col-website">Website</th>
              ...
              <th scope="col" className="col-descr">Description</th>
              <th scope="col" className="col-event-crud">Edit / Delete</th>
              </tr>
            </thead>
